...
from gripper_core import Modbus, Transform, Script, Move, TM_Exception, Pickplace_Driver
from gripper_msgs.srv import GetPosition
from gripper_msgs.msg import MovePosition
...
def main():
    ...
    flagpublisher = pickplace_node.create_publisher(MovePosition, 'objectflag', 10)
    vjob_name = ""
    view_pick = []
    view_place = []
    vbase_pick = []
    ...
    cli = pickplace_node.create_client(GetPosition, 'ask_modbus')
